...
void Light_IncTick(void)
{
    user_light_control.light_uptime ++;
}

void Light_Updata_Loop(void)
{
    ...
    if(user_light_control.light_uptime >= 5)
    {
        ...
        if(user_light_control.light_mode == 2)
        {
            ...
            user_ws2812_control7.ws2812_color_updata_index(grb,index++,&user_ws2812_control7);
        }
        else
        {
...
static unsigned char dp_download_work_mode_handle(const unsigned char value[], unsigned short length)
{
    ...
    switch(work_mode) {
        case 0: user_light_control.light_mode = 0;
        break;
        
        case 1: user_light_control.light_mode = 1;
        break;
        
        case 2: user_light_control.light_mode = 2;
        break;
        
        default:user_light_control.light_mode = 0;
...
static unsigned char dp_download_colour_data_handle(const unsigned char value[], unsigned short length)
{
    ...
    {
        str2rgb(value, length, user_light_control.new_color_rgb);
        user_light_control.light_flag = 1;
    }
...
static unsigned char dp_download_music_data_handle(const unsigned char value[], unsigned short length)
{
    ...
    if(user_light_control.light_mode == 2)
    {
        str2rgb(&value[1], 12, user_light_control.music_color_rgb);
        user_light_control.light_flag = 1;
    }
